...
- **FR-007**: System MUST generate a plain-language description targeting ≤25 words for each field. Descriptions exceeding 25 words are flagged in the QA report but not truncated.
